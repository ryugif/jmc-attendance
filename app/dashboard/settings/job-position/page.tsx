...
import { getList, search, deleteItem } from "@/app/dashboard/settings/job-position/actions"
...
const addButton = (
    <Link
        href="/dashboard/settings/job-position/create"
    >
...
export default function JobPositionSettingsPage() {
    ...
    const fetchJobPositions = async (page: number, query: string = "") => {
    ...
    useEffect(() => {
        ...
        const timeoutId = window.setTimeout(() => {
            fetchJobPositions(1, searchQuery);
        }, 300);
    ...
    const handlePageChange = (newPage: number) => {
        fetchJobPositions(newPage, searchQuery);
    };
    ...
    const handleConfirmDelete = async () => {
        ...
        setIsDeleting(true);
        try {
            await deleteItem(jobPositionToDelete.id);
            setDeleteDialogOpen(false);
            setJobPositionToDelete(null);
            // Refresh the list
            fetchJobPositions(pagination.page, searchQuery);
        } catch (error) {
    ...
    const emptyState = isSearching ? (
        <Empty>
            <EmptyHeader>
                ...
                <EmptyTitle>No job positions found</EmptyTitle>
                <EmptyDescription>No job positions found matching your search</EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
                {addButton}
            </EmptyContent>
        ...
        <Empty>
            <EmptyHeader>
                ...
                <EmptyTitle>No job position</EmptyTitle>
                <EmptyDescription>No job positions have been added yet.</EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
                {addButton}
            </EmptyContent>
    ...
    return (
        <div className="space-y-6">
            <GlobalHeader title="Job Positions" description="Manage the job positions within your organization." />
            ...
            <div className="flex items-center justify-between gap-4">
                <div className="relative w-full">
                    ...
                    <Input
                        placeholder="Search job positions by name or description"
                        value={searchQuery}
                                ...
                                <TableCell className="text-right">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            <Link href={`/dashboard/settings/job-position/${jobPosition.id}/edit`}>
            ...
            <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <AlertDialogContent>
                    ...
                    <AlertDialogDescription>
                        Are you sure you want to delete <strong>{jobPositionToDelete?.name}</strong>? This action cannot be undone.
                    </AlertDialogDescription>
